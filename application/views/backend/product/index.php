								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center text-middle">
											...
											<div >
												<a href="<?php echo site_url('product/admin_edit'); ?>/<?php echo $product['product_id']; ?>">
													<button class="btn btn-warning btn-sm" style="font-weight: bold;width: 49%;float: left;margin-right: 2%;">
														<i class="fa fa-edit"></i> คืนของ
													</button>
												</a>
											</div>
											...
											<div style="margin-top:2%;">
												...
												<button type="button" value="<?php echo $product['product_id'] ?>" class="btn btn-danger btn-sm" style="font-weight: bold;width: 49%;float: right;"
												 onclick="deleteConfirm(this.value);">
